...
class EnableGeoShardingCmd : public Command {
public:
    EnableGeoShardingCmd() : Command("enableGeoSharding", false, "enablegeosharding") {}
...
*/
    virtual bool run(OperationContext* txn,
        ...
        errmsg = "geo sharding command not implemented!";
        return false;
    }
